...
from data_generator import get_test_tiny_imagenet_adv_loader,get_handled_cifar10_train_loader,get_handled_cifar10_test_loader,get_test_adv_loader
...
if __name__ == '__main__':
    ...
    # data
    test_loader = get_test_tiny_imagenet_adv_loader(attack_method=args.attack_method,epsilon=args.epsilon)


    # load net
    save_dir = "checkpoint"
    file_name = 'resnet50_epoch_22.pth'
